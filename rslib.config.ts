...
export default defineConfig({
  source: {
    entry: {
      ...
      "test-ai-response-queue": "./src/scripts/test-ai-response-queue.ts",
      "test-ai-generate-response": "./src/scripts/test-ai-generate-response.ts",
      "test-ai-flow-with-mock": "./src/scripts/test-ai-flow-with-mock.ts",
      "test-send-sms": "./src/scripts/test-send-sms.ts",
    },
  },
